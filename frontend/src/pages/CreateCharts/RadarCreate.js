...
export function RadarCreate () {
    ...
    const column_aggregateFunc = ['AVG', 'SUM', 'MIN', 'MAX']
    return (
        <div className="wrapperForm">
            <div className="tools">
                <div className="parameter">
                    <span>Агрегатная функция</span>
                    <Popup trigger={<input type="text" value={aggregateFunc} placeholder="Выберите функцию" readOnly/>}
                           position="right center" closeOnDocumentClick={!isOpen}>
                        <ColumnSelectionModal columns={column_aggregateFunc} onSelectColumn={selectedColumn => handleColumnSelection(setAggregateFunc, selectedColumn, true)} setSelection={setAggregateFunc} onClose={(opened) => {handleIsOpenPopup(opened, setIsOpen)}}/>
                    </Popup>
                </div>
                <div className="parameter">
            ...
            <div className="chart" id="chartContainer" ref={divRef}>
                <RadarChar nameDataset={SavedChooseGraph}
